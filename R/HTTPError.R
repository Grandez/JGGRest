...
#'
HTTPError = NULL # see zzz.R on how JGGRest initializes this object during .onLoad
...
HTTPErrorFactory = R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @details
    #' Modifying [HTTPError] will have global impact on JGGRest functionality.
    #'
    ...
    #'   also the errors format produced by JGGRest. Same holds for
    ...
    #' @description
    #' Resets `HTTPError` to the default JGGRest state.
    reset = function() {
...
#'
#' @description
#' Interrupts request processing and signals JGGRest to return HTTPError
#'
