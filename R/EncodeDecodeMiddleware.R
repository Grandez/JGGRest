...
#'
#' @description
#' Controls how JGGRest encodes and decodes different content types.
...
EncodeDecodeMiddleware = R6::R6Class(
  ...
  inherit = Middleware,
  public = list(
    #' @field ContentHandlers Class which controls how JGGRest encodes and
    ...
    #'   (see `JGGRest:::ContentHandlersFactory`). However we believe that in
