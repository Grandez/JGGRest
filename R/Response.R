...
#' rs = Response$new()
#' # static file path
#' file_path = system.file("DESCRIPTION", package = "JGGRest")
...
Response = R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(body = NULL,
                          ...
                          headers = list("Server" = getOption("JGGRest.headers.server")),
                          status_code = 200L,
                          encode = NULL,
                          ...) {
    ...
    #'   JGGRest internals - resetting R6 class is much faster then initialize it.
    reset = function() {
      self$body = NULL
      self$set_content_type("text/plain")
      self$headers = list("Server" = getOption("JGGRest.headers.server"))
