...
#'
#' @description
#' Adds CORS to [Application]. CORS Middleware out of the box in JGGRest to turn on/off the CORS
...
#' browsers to avoid request between different domains. To allow it JGGRest
...
#' by the browser as default because JGGRest will not send the headers required
...
#'   res$set_body("Hello from JGGRest!")
#' })
